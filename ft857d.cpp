 ...
 *
 * Rod, AD5GH, May 27, 2020, added SoftwareSerial to accomodate inverse serial logic
 * used by Timewave Navigator.
 *
 * **************************************************************************/
...
SoftwareSerial catSerial(12, 13, 1);    // RX pin, TX pin, inverse logic true
...
void ft857d::sent(byte amount) {
    ...
    for (byte i=0; i<amount; i++) catSerial.write(nullPad[i]);
}
